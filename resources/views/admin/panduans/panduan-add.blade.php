  ...
  <div class="row">
      <div class="col">
          <div class="card bg-secondary shadow h-100">
              ...
              <div class="card-body">
                  <form autocomplete="off" action="{{ Route('panduan.store') }}" method="post" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                          <label class="form-control-label">Gambar</label>
                          <div class="text-center">
                              <img onclick="$(this).siblings('.images').click()" class="mw-100 upload-image" style="max-height: 300px" src="{{ asset('storage/panduan/upload.jpg') }}" alt="">
                      ...
                      <div class="form-group">
                          ...
                          <textarea class="form-control @error('konten') is-invalid @enderror" name="deskripsi">{{ old('deskripsi') }}</textarea>
