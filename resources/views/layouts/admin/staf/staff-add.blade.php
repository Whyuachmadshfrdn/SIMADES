                ...
                <form action="/add-staff" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nip_staff" type="number" class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <input name="no_telp" type="number" class="form-control" id="exampleInputEmail1"
                                placeholder="Masukan nomer telpon yang aktif">
                        </div>
                        <div class="form-group">
