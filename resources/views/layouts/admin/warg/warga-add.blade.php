      ...
      <form action="{{ route('warga.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input name="nama_warga" type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Lengkap">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">NIK</label>
            <input name="nik_warga" type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukan NIK">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">No.KK</label>
            <input name="kk" type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukan No. Kartu Keluarga">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="gol_darah" type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Golongan Darah">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="nama_ayah" type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Ayah">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="kelurahan" type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Kelurahan">
          </div>
          <div class="form-group">
